...
from .utils.address import (
    ...
    RE_ADDRESS_room,
    replace_address,
    replace_address_room,
)
from .utils.chronology import (
    RE_DATE,
    RE_DATE2,
    RE_TIME,
    RE_TIME_2,
...
from .utils.num import (
    ...
    RE_POSITIVE_QUANTIFIERS_2,
    RE_RANGE,
    replace_default_num_with_altone,
    replace_default_num_without_altone,
    replace_frac,
    replace_license_plate,
    replace_negative_num,
    replace_number,
    replace_percentage,
    replace_positive_quantifier,
    replace_positive_quantifier_2,
    replace_range,
)
from .utils.phonecode import (
    RE_MOBILE_PHONE,
...
from .utils.quantifier import RE_TEMPERATURE, replace_temperature
from .utils.string_operator import BLANK_CHAR  # noqa
from .utils.string_operator import (
    PUNC_MAP_OTHER2CN,
    PUNC_MAP_STANDARD,
    PUNC_STANDARD,
    REGEX_CN,
